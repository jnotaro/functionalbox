...
def network(request):
    ...
    return render(request, 'basecore/network.html', {'users': users})
...
def settings(request):
    ...
    return render(request, 'basecore/settings.html', {'form': form})
...
def picture(request):
    ...
    return render(request, 'basecore/picture.html',
...
def password(request):
    ...
    return render(request, 'basecore/password.html', {'form': form})
